...
const ProfileButtons: React.FC = () => {
  return (
    <div className="flex flex-col gap-4">
      <button className="bg-primary text-white px-6 py-3 rounded-full flex items-center gap-2 hover:scale-105 transform transition duration-200 ease-in-out shadow-lg">
